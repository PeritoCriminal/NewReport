...
class HeaderReportForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'incident_nature', 'police_station', 'requesting_authority', 'photographer',
            ]
        widgets = {
            ...
            'photographer': forms.TextInput(attrs={'class': 'form-control', 'maxlength': 150,'placeholder': 'Ex. Jadir Tonelo.'}),
        ...
        help_texts = {
            ...
            'photographer': 'Informe o nome do fotógrafo. Esse campo não é obrigatório',
        }
