...
urlpatterns = [
    ...
    path('report/location_data_report/<int:header_report_id>/', location_data_view, name='create_locate_data_report'),
    ...
    path('report/for_custody_report/<int:header_report_id>/', for_custody_view, name='create_for_custody_report'),
