...
from .views import change_password_view, edit_user_profile_view, register_user, post_delete_views, post_likes_views, user_login_view, home_views, create_post_view
