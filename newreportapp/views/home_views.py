...
def home_views(request):
    ...
    is_authenticated = request.user.is_authenticated #friends
    ...
    if is_authenticated:
        ...
        posts = public_posts.union(user_posts).order_by('-created_at')  # Ordena as postagens da mais recente para a mais antiga
