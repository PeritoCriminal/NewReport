...
def veicles_view(request, id=None, header_report_id=None):
    subject = "veicles"
    ...
    Utilize para descrever os veículos.
    ...
    return render(request, 'report/veicles_report.html', {
