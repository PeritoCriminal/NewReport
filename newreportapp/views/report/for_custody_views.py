...
def for_custody_view(request, id=None, header_report_id=None):
    subject = "peças"

    # Alterar o valor do atributo abaixo para diferentes subsecções.
    title = "Remessa Para Autoridade Requisitante"

    # Alterar rota com o nome no arquivo URLS.
    rota = "edit_for_custody_report"
    ...
    Utilize para descrever e relacionar os objetos enviados à Autoridade Requisitante.
    ...
    return render(request, 'report/for_custody_report.html', {
