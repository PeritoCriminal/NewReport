...
def for_analysis_view(request, id=None, header_report_id=None):
    subject = "peças"

    # Alterar o valor do atributo abaixo para diferentes subsecções.
    title = "Elementos Enviados Para Análise"

    # Alterar rota com o nome no arquivo URLS.
    rota = "edit_for_analysis_report"
    ...
    Utilize para descrever e relacionar os objetos que foram enviados para análise.
    ...
    return render(request, 'report/for_analysis_report.html', {
