...
def fingerprints_view(request, id=None, header_report_id=None):
    ...
    Utilize para descrever os impressões datiloscópicas encontradas no local ou nos objetos recolhidos.
    ...
    return render(request, 'report/fingerprints_report.html', {
